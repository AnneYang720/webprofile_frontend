<template>
  <div>
    ...
    <el-table 
      ...
      <el-table-column prop="projectName" label="所属项目" min-width="20%"></el-table-column>
...
export default {
    data(){
        return {
          ...
          currentProjectName:'', //当前选中行文件所属的项目名称
    ...
    methods: {
        ...
        handleSearch(){
          if(this.keywords==='') this.list =[];
          else {
            projectApi.search(this.currentPage, this.pageSize, this.keywords).then(response =>{
        ...
        rowClick(row, column, event) {
          ...
          this.expandProjectId = row.projectId
